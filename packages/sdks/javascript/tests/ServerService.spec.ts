...
test('convertToHostname() util method', () => {
  const list = [
    ...
    [
      '-2+5=7? não véi, cê é doido? e o signed two?',
      '2-5-7-nao-vei-ce-e-doido-e-o-signed-two',
    ],
    [
      ' Espaço no início melhor ignorar---varioshifens_tb',
      'espaco-no-inicio-melhor-ignorar-varioshifens-tb',
    ],
    ['-- test --', 'test'],
