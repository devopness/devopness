...
class CloudServiceSettingsHetznerHcloud(DevopnessBaseModel):
    """
...
class CloudServiceSettingsHetznerHcloudPlain(TypedDict, total=False):
    """
    Plain version of CloudServiceSettingsHetznerHcloud.
    """
