...
class Service(DevopnessBaseModel):
    """
    Service
    ...
    Attributes:
        ...
        version (str, optional): The service current installed version
        ...
        description (str, optional): A text describing the service, provided by the service author
...
class ServicePlain(TypedDict, total=False):
    """
    Plain version of Service.
    """
