...
class ApplicationUpdate(DevopnessBaseModel):
    ...
    Attributes:
        ...
        credential_id (int): Numeric ID of the credential to source provider where the repository is hosted. This field is required when &lt;code&gt;repository&lt;/code&gt; is present.
