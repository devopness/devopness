...
class PersonalAccessTokenRotateResponse(DevopnessBaseModel):
    """
...
class PersonalAccessTokenRotateResponsePlain(TypedDict, total=False):
    """
    Plain version of PersonalAccessTokenRotateResponse.
    """
