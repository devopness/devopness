...
class ApplicationApplyTemplateResponse(DevopnessBaseModel):
    """
...
class ApplicationApplyTemplateResponsePlain(TypedDict, total=False):
    """
    Plain version of ApplicationApplyTemplateResponse.
    """
