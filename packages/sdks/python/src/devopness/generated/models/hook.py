...
class Hook(DevopnessBaseModel):
    ...
    Attributes:
        ...
        url (str, optional): URL that triggers incoming hooks
        target_url (str, optional): URL that outgoing hooks make a request to
        ...
        pipeline_id (int, optional): The ID of the pipeline executed by this hook
        resource_type (ResourceType):
        resource_id (int): The hooks&#39; resource ID
        settings (HookSettings, optional):
        ...
        secret_algorithm (str, optional): The cryptographic hash function to be used by Devopness when validating digitally signed incoming requests for hooks that require secret validation
        secret_header_name (str, optional): The name of the HTTP request header from which the request digital signature should be extracted
