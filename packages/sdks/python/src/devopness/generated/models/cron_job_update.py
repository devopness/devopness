...
class CronJobUpdate(DevopnessBaseModel):
    ...
    id: StrictInt = Field(
        description="The unique ID of the given Cron Job.",
    ...
    name: StrictStr = Field(
        ...
        json_schema_extra={"examples": ["My cool cron job"]},
    )
    command: StrictStr = Field(
        ...
        json_schema_extra={
            "examples": ["echo 'devopness rocks!' | tee -a /tmp/task-output.log"]
        },
    )
