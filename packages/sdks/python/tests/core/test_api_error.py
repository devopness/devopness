...
@respx.mock
def test_devopness_api_error_with_validation_errors() -> None:
...
@respx.mock
def test_devopness_api_error_with_simple_error_message() -> None:
...
@respx.mock
def test_devopness_api_error_with_non_json_response() -> None:
...
@respx.mock
def test_devopness_api_error_with_empty_json() -> None:
...
@respx.mock
def test_devopness_api_error_with_blank_message_falls_back_to_httpx() -> None:
