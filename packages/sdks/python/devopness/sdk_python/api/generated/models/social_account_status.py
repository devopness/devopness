...
class SocialAccountStatus(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["provider", "connected", "connect_url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SocialAccountStatus from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SocialAccountStatus from a dict"""
        if obj is None:
            return None
