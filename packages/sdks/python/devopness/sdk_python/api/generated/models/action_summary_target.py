...
class ActionSummaryTarget(BaseModel):
    """
    ActionSummaryTarget
    """ # noqa: E501
    ...
    in_progress: StrictInt = Field(description="The number of action targets in progress")
    ...
    __properties: ClassVar[List[str]] = ["count", "pending", "in_progress", "completed", "failed"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ActionSummaryTarget from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ActionSummaryTarget from a dict"""
        if obj is None:
            return None
