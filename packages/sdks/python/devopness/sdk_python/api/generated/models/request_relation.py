...
class RequestRelation(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "hook_id", "action_id", "retry_of", "ip_address", "created_at", "updated_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RequestRelation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RequestRelation from a dict"""
        if obj is None:
            return None
