...
class PipelineRelation(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "environment_id", "project_id", "resource_type", "resource_type_human_readable", "resource_id", "operation", "operation_human_readable", "max_parallel_actions", "trigger_when", "created_by_user", "created_at", "updated_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PipelineRelation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PipelineRelation from a dict"""
        if obj is None:
            return None
