...
class NetworkRuleEnvironmentCreate(BaseModel):
    """
    ...
    port: StrictInt = Field(description="Network port to be considered by this rule. Must be at least 1. Must not be greater than 65535.")
    __properties: ClassVar[List[str]] = ["linked_resources", "name", "direction", "protocol", "cidr_block", "port"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NetworkRuleEnvironmentCreate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NetworkRuleEnvironmentCreate from a dict"""
        if obj is None:
            return None
