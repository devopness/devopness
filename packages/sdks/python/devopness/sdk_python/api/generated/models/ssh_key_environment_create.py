...
class SshKeyEnvironmentCreate(BaseModel):
    """
    ...
    name: StrictStr = Field(description="The ssh key's name. Must not be greater than 60 characters.")
    public_key: StrictStr = Field(description="The public key of the ssh key.")
    __properties: ClassVar[List[str]] = ["linked_resources", "name", "public_key"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SshKeyEnvironmentCreate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SshKeyEnvironmentCreate from a dict"""
        if obj is None:
            return None
