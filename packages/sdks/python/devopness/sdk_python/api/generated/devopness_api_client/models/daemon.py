...
class Daemon(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "command", "run_as_user", "working_directory", "process_count", "is_auto_generated", "project", "last_action", "application", "environment", "servers", "created_by_user", "created_at", "updated_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Daemon from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Daemon from a dict"""
        if obj is None:
            return None
