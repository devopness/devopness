...
class TeamRelation(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "photo_url", "created_at", "updated_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TeamRelation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TeamRelation from a dict"""
        if obj is None:
            return None
