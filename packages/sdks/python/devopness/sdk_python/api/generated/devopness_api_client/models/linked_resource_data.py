...
class LinkedResourceData(BaseModel):
    """
    ...
    summary_fields: Optional[List[LinkedResourceSummaryField]] = Field(default=None, description="The summary of linked resource fields")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "summary_fields", "created_at", "updated_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LinkedResourceData from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.summary_fields:
            ...
            _dict['summary_fields'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LinkedResourceData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "summary_fields": [LinkedResourceSummaryField.from_dict(_item) for _item in obj["summary_fields"]] if obj.get("summary_fields") is not None else None,
