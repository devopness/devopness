...
class Role(BaseModel):
    ...
    is_predefined: StrictBool = Field(description="Defines if the role is predefined or custom")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "project_id", "is_predefined", "permissions", "parent", "created_at", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parent": RoleRelation.from_dict(obj["parent"]) if obj.get("parent") is not None else None,
