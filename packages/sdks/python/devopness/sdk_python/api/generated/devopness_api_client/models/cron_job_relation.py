...
class CronJobRelation(BaseModel):
    """
    CronJobRelation
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "command", "run_as_user", "pattern", "pattern_human_readable", "is_auto_generated", "last_action", "created_by_user", "application", "created_at", "updated_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CronJobRelation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CronJobRelation from a dict"""
        if obj is None:
            return None
