...
describe('Alert', () => {
  ...
  describe('styling for different alert types', () => {
    it('renders error alert structure', () => {
      ...
      // TODO: Fix test env to verify styles: background-color, color, border
    })
    ...
    it('renders success alert structure', () => {
      ...
      expect(content).toBeInTheDocument()
      expect(icon).toBeInTheDocument()
      // TODO: Fix test env to verify styles
    })
  ...
  describe('handling of long text', () => {
    it('renders long text', () => {
      ...
      // TODO: Fix test env to verify white-space: pre-wrap
    })
  })
  ...
  describe('close button functionality', () => {
    it('renders close button when canClose is true and triggers onClose', () => {
      ...
      if (closeButton) fireEvent.click(closeButton) // Type guard ensures closeButton is not null
  ...
  describe('padding variations', () => {
    it('renders with default padding structure', () => {
      ...
      // TODO: Fix test env to verify padding-top: 42px, padding-bottom: 20px
    })
    ...
    it('renders without padding when noPadding is true', () => {
      ...
      const wrapper = screen
        ...
        .closest('div')?.parentElement
      expect(wrapper).toBeInTheDocument()
      // Padding is unset (not testable without style fix)
    })
  })
})
