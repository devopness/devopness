...
const dotnetCoreAspnetCoreSVG = getImageAssetUrl('icons_svgs/dotnetcore-aspnetcore.svg')
...
const mdOutlineShieldLockSVG = getImageAssetUrl('icons_svgs/outline-shield-lock.svg')
...
const typeHierarchySubSVG = getImageAssetUrl('icons_svgs/type-hierarchy-sub.svg')
const typeHierarchySuperSVG = getImageAssetUrl('icons_svgs/type-hierarchy-super.svg')
const ubuntuSVG = getImageAssetUrl('icons_svgs/ubuntu.svg')

const iconList = [
  { type: 'icon', accessor: 'add', component: MdAdd },
  { type: 'icon', accessor: 'aiOutlineDollarCircle', component: AiOutlineDollarCircle },
  ...
  { type: 'icon', accessor: 'children', component: typeHierarchySuperSVG },
  ...
  { type: 'image', accessor: 'dotnetcore-aspnetcore', component: dotnetCoreAspnetCoreSVG },
  ...
  { type: 'icon', accessor: 'parent', component: typeHierarchySubSVG },
