...
See the [contributing guide](CONTRIBUTING.md) for details on how to participate. If you use AI tools to contribute, also read [AGENTS.md](AGENTS.md) for repository-specific guidance.
...
| Subpath | Description |
|:--------|:------------|
| [/examples/applications](examples/applications/) | Sample applications showing Devopness integrations (e.g. Ruby on Rails) |
