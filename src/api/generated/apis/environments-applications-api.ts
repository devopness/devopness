...
export class EnvironmentsApplicationsApiService extends ApiBaseService {
     ...
     */
    public async listEnvironmentApplications(environmentId: number, page?: number, perPage?: number): Promise<ApiResponse<Array<Application>>> {
        ...
        const response = await this.get <Array<Application>>(requestUrl.replace(`{${"environment_id"}}`, encodeURIComponent(String(environmentId))));
