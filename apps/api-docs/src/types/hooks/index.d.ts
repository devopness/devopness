declare module 'hooks'{
  ...
  export type TransactionHook = (transaction: Transaction) => void;
  ...
  export function afterAll(hook: TransactionListHook): void;
  export function beforeEach(hook: TransactionHook): void;
  export function beforeEachValidation(hook: TransactionHook): void;
  export function afterEach(hook: TransactionHook): void;
  export function addHook(hooks: TransactionHook[], name: string, hook: TransactionHook): void;
  //@ts-ignore
  export function log(...any): void;
}
