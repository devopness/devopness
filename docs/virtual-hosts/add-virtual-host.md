...
1. Copy the IP Address of the server to which the virtual host has been deployed
    - Follow the guide [`/docs/servers/find-server-ip-address`](/docs/servers/find-server-ip-address)
...
**NOTE**: in order to secure all network connections with your virtual host, and ensure all data submitted to your domain name is encrypted over the HTTPS protocol, follow the guide on how to [`/docs/ssl-certificates/add-ssl-certificate`](/docs/ssl-certificates/add-ssl-certificate)
