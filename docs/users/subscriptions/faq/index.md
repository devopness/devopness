...
For detailed instructions, see:
- <MentionPost path="/docs/users/subscriptions" />
...
3. In environments using custom <MentionPost path="/docs/roles" /> in their <MentionPost path="/docs/environments/team-memberships" />, the membership will be updated to use the role “Read”, converting all users to read-only users.
