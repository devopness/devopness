...
- <MentionPost path="/docs/users/subscriptions/upgrade-subscription" />.
...
See also:
- <MentionPost path="/docs/actions/index" />
...
For detailed instructions, see:
- <MentionPost path="/docs/users/subscriptions/index" />
...
## How do I add credits to my account?
To add credits to your account, <MentionPost path="/docs/users/subscriptions/upgrade-subscription" />.
...
See also:
- <MentionPost path="/docs/users/subscriptions/cancel-subscription" />
- [What happens after my subscription is canceled?](#)
...
3. In environments using custom <MentionPost path="/docs/roles/index" /> in their <MentionPost path="/docs/environments/team-memberships/index" />, the membership will be updated to use the role “Read”, converting all users to read-only users.
