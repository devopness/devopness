...
- The applications belong to different products or business units.
...
- Separate projects: `app-a` and `app-b` are independent products with different teams or different credentials.
