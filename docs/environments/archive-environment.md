...
The project owner can unarchive an archived environment, making it active and accessible to other team members. For more information, see [`/docs/environments/unarchive-environment`](/docs/environments/unarchive-environment)
