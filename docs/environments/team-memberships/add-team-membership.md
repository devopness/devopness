...
1. Assign a `Role` to the team to grant team members permissions on the environment
    - To check a role's details, please follow the guide <MentionPost path="/docs/roles/view-role" />
    - If no role listed satisfies the permissions needed for the team, please follow the guide <MentionPost path="/docs/roles/add-role" />
1. Click `CONFIRM`
