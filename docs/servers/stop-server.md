...
1. In the list of servers, find the running server you want to start and click `DETAILS`
    > If you don’t have any running servers, follow the guide [Start a Server](/docs/servers/start-server)
3. On the upper-right corner of the running server details view click `ACTIONS`
